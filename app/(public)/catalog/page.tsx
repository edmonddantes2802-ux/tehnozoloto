        ...
        <div className="grid gap-8 lg:grid-cols-[260px_1fr]">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {products.map((p) => (
              <article
                key={p.id}
                className="overflow-hidden rounded-card border border-corporate-border bg-white shadow-card-rest transition-shadow hover:shadow-card-hover"
              >
                ...
                <div className="p-5">
                  ...
                  <div className="mb-3 text-xs text-corporate-muted">{p.description}</div>
